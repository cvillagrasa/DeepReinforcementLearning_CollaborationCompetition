...
class TennisEnvironment:
    env_path: ... = Path('./Tennis_Linux/Tennis.x86_64')
    env = None
    ...
    def get_observation_space_size(self):
        ...
        vector_observations = env_info.vector_observations
    ...
    def train(self, n_episodes=2000, max_t=np.inf, metrics_log_size=100, save=False, saveas='checkpoint'):
        ...
        for episode in range(n_episodes):
            ...
            if self.train_mode and save and max_score > overall_max_score:
                self.save_parameters(saveas)
            overall_max_score = max_score if max_score > overall_max_score else overall_max_score
        return scores
